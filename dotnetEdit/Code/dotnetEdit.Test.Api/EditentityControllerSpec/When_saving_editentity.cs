...
{
    public class When_saving_editentity : UsingEditentityControllerSpec
    {
        ...
        public override void Context()
        {
            ...
            _editentityService.Save(_editentity).Returns(_editentity);
        ...
        {
            _editentityService.Received(1).Save(_editentity);
        ...
        public void Appropriate_result_is_returned()
        {
            ...
            var resultList = (EditentityDto)resultListObject;
