...
{
    public class When_deleting_editentity : UsingEditentityServiceSpec
    {
        ...
        public override void Context()
        {
            ...
            _editentityRepository.Delete(Id).Returns(true);
        }
        ...
        {
            _editentityRepository.Received(1).Delete(Id);
